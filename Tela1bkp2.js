...
import { Picker } from '@react-native-picker/picker'; // Importe Picker do pacote corretamente
...
export default function Tela1() {
    ...
    const [arrematanteIdInput, setArrematanteIdInput] = useState('');
    ...
    useEffect(() => {
        ...
        fetch('https://leilao-rest-api.herokuapp.com/participante')
            ...
            .then((json) => {
                ...
                setLoading(false); // Defina o loading como false após o carregamento
            })
            .catch((error) => {
                console.error(error);
                setLoading(false); // Certifique-se de definir o loading como false em caso de erro
            });
    }, []);
    ...
    const enviar = () => {
        if (selectedArrematante === '' || valor === '') {
            ...
            // Enviar o objeto JSON com o valor e o ID do arrematante selecionado
            const arrematanteSelecionado = selectedArrematante; // Use o arrematante selecionado diretamente
            const lanceObj = {
